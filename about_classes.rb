...
class AboutClasses < Neo::Koan
  ...
  def test_you_can_create_accessor_methods_to_return_instance_variables
    fido = Dog3.new
    fido.set_name("Fido")
    # call regularly now that a getter method is in place
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # saying you can't instantiate a class without certain properties
  end
