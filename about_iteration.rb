...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # enumerable. can take optional argument for starting number
    # (will be first placeholder value). saves the
    # number after each operation while iterating throught the array.
    # Accumulative
  end
