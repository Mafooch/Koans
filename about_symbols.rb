...
class AboutSymbols < Neo::Koan
  ...
  # Is it because only than can we us the 'include?' function?
  ...
  # They're immutable and thus will stay in memory unitl the program exits. You
  # won't be using your memory very sparingly
end
